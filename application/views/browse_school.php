...
<a <?php echo $hideprev; ?> class="btn-other" href="<?php echo base_url()."browse/school/".$id."/".$prev; ?>">< previous</a>
<span class="pageNum">Page <?php echo $current; ?> of <?php echo $pgs; ?></span>
<a <?php echo $hidenext; ?> class="btn-other" style="float:right;" href="<?php echo base_url()."browse/school/".$id."/".$next; ?>">next ></a>
</div>
<?php } ?>	
<div id="clear"></div>