...
<div id="rightContent">
<h3>Editing <?php echo $name; ?>  <a style="float:right; margin-top:-15px;" class="btn-other" href="<?php echo base_url(); ?>item/deleteGroup/<?php echo $id; ?>/<?php echo $g_id; ?>">delete this item</a></h3>
<form method="post" action="<?php echo base_url(); ?>item/update_group/<?php echo $id; ?>" name="save_changes" accept-charset="utf-8" enctype="multipart/form-data">
