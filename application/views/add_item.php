...
<div id="rightContent">
<h3>List an Item</h3>
<form method="post" action="<?php echo base_url(); ?>item/save" name="save_changes" accept-charset="utf-8" enctype="multipart/form-data">
<div class="box">
	<label>Name</label>
	...
	<textarea name="about" style="width:400px; height:100px;"><?php echo set_value('about'); ?></textarea>
...
<div class="box">
	...
	<input type="text" name="shipping_cost" value="<?php echo set_value('shipping_cost'); ?>"/>
	<p class="caption">How much will it cost to ship?</p>
</div>
<h3>Size (Optional)</h3>
<div class="box">
	<label>Size Options</label>
	<input type="text" name="size" value="<?php echo set_value('size'); ?>"/>
	<p class="caption">Enter size options, seperated by commas. Example: Small, Medium, Large</p>
	<label>Dimensions</label>
	<input type="text" name="dimensions" value="<?php echo set_value('dimensions'); ?>"/>
...
<div class="box">
	...
	<input type="text" name="material" value="<?php echo set_value('material'); ?>"/>
	<p class="caption">What's it made of? Materials, seperated by commas.</p>
	<label>Tags</label>
	<input type="text" name="tags" value="<?php echo set_value('tags'); ?>"/>
	<p class="caption">Enter tags, seperated by commas</p>
	<label>How it's made</label>
	<textarea name="how_it_is_made" style="width:400px; height:100px;"><?php echo set_value('how_it_is_made'); ?></textarea>
</div>	
